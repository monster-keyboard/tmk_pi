...
/*3*/ KR( TAB,   Q,   W,   E,   R,   T,   Y,   U,   I,   O,   P,LBRC,RBRC,BSLS, DEL, END,PGDN,  P7,  P8,  P9,PPLS, ___, ___, ___),
/*4*/ KR(CAPS,   A,   S,   D,   F,   G,   H,   J,   K,   L,SCLN,QUOT, ___, ENT, ___, ___, ___,  P4,  P5,  P6, ___, ___, ___, ___), 
/*5*/ KR(LSFT,   Z,   X,   C,   V,   B,   N,   M,COMM, DOT,SLSH, ___, ___,RSFT, ___,  UP, ___,  P1,  P2,  P3,PENT, ___, ___, ___), 
/*6*/ KR(LCTL,LGUI,LALT, ___, ___, SPC, ___, ___, ___, ___,RALT,RGUI,MENU,RCTL,RGHT,DOWN,LEFT,  P0, ___,PDOT, ___, ___, ___, ___),
